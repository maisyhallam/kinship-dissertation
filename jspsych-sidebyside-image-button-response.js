...
// NOTE: This plugin has been adapted from the existing image-button-response JSPsych plug in.

jsPsych.plugins["sidebyside-image-button-response"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('sidebyside-image-button-response', 'stimulus', 'image');

  plugin.info = {
    name: 'sidebyside-image-button-response',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    console.log(html)
      ...
      //add div for image
      html += "<div id='imageleft_align' style='display: inline-block; width:50%'>";
