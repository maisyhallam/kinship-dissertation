 ...
 * Maisy Hallam (modified from Josh de Leeuw and Chris Jungerius)
 *
 * a jsPsych plugin for displaying a canvas stimulus and getting a button response,
 * with canvas displayed on the left and buttons on the right instead of centred
 * 
 * documentation: docs.jspsych.org
 *
 **/

// NOTE: I edited the existing canvas-button-response jsPsych plugin in order to suit the needs of my MSc dissertation experiment.
// Due to the large number of image buttons my participants needed to see in the comprehension trials, it was not suitable to show
// the canvas in the centre of the screen with the buttons underneath.

jsPsych.plugins["sidebyside-canvas-button-response"] = (function () {

    var plugin = {};

    plugin.info = {
        name: 'sidebyside-canvas-button-response',
        description: '',
        parameters: {
            stimulus: {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        html += "<div id='canvasleft_align' style='display: inline-block; width:50%'>";
        html += '<div id="jspsych-canvas-button-response-stimulus">' + '<canvas id="jspsych-canvas-stimulus" height="' + trial.canvas_size[0] + '" width="' + trial.canvas_size[1] + '"></canvas>' + '</div>';

        //display buttons
        var buttons = [];
        html += "<div id='buttons_right_align' style='display: inline-block; width:50%'>";
