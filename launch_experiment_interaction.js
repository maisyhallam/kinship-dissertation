...
// get the partcipant's prolific ID
...
var consent_screen = {
    ...
    <p style='text-align:left'>This is an experiment about family relationships, and how we express them through language. Your session should last approximately 55 minutes, for which you will be paid £6.90. \
    The final section of this experiment involves a communication game: you will receive a 2p bonus for each correctly answered question in this section (max £1.24).\
    ...
    <p style='text-align:left'> Before you begin, please take a moment to read <a href='./consent_form_cond_2.pdf' target='_blank' rel='noopener noreferrer'>this information letter</a>, which explains your rights and the terms of your participation.</p> \
...
var PROLIFIC_COMPLETION_CODE = "70037B7B" //needed for submission by redirect at end 
